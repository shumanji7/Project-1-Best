...
//INCLUDED ROBERTO - END
    ...
    //INCLUDED ROBERTO - BEGIN
    // <button type="button" id="add-assessments-btn" class="btn">Grade of Assessment</button>              
    document.getElementById('add-assessments-btn').addEventListener('click', function() {
        displayAverageScores();    
